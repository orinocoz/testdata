...
MySQL  backups are created every day ; it takes up to _____ to create and store the backup.

Prometheus backups are created every day ; it takes up to _____ to create and store the backup.

Loki backups are created every day; it takes up to _____ to create and store the backup.

All backups are started automatically by 2:00 UTC.
